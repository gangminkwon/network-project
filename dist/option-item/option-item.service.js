...
exports.OptionItemService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const option_item_entity_1 = require("../entities/option-item.entity");
let OptionItemService = class OptionItemService {
    constructor(optionItemRepository) {
    ...
    async saveOptionItem(optionItem) {
        let { id } = optionItem, x = __rest(optionItem, ["id"]);
...
OptionItemService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(option_item_entity_1.OptionItem)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], OptionItemService);
exports.OptionItemService = OptionItemService;
//# sourceMappingURL=option-item.service.js.map